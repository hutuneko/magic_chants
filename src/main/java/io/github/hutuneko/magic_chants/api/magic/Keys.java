...
public final class Keys {
    ...
    public static final Codec<MagicSpend.Target> TARGET_CODEC =
            Codec.STRING.xmap(MagicSpend.Target::valueOf, MagicSpend.Target::toString);
    ...
    public static final DataKey<MagicSpend.Target> TARGET =
            DataKey.of(NS,"target",TARGET_CODEC);
}
